...
| v0.7    | `github-pr`-signalkälla för inaktuella PR:er                        | planerad   |
| v0.8    | Claude Codes `triage`-skill (i `claude_skill-Triage`-repo)          | planerad   |
| v0.9    | `triage watch`-långkörande läge + systemd-enhet                     | planerad   |
